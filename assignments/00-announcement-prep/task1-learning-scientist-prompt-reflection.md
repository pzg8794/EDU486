...
- Observes before interpreting behavior as ability, motivation, or attitude.
- Treats youth questions, community knowledge, disability culture, bodymind experience, and multilingual practices as evidence.
- Designs with technology, but does not assume technology is always the best answer.
- Documents learning, participation, access, energy, sensory load, language load, and motivation.
- Separates access barriers from thinking barriers.
- Revises plans based on what students actually do, say, build, avoid, mask, ask for, and need.
- Notices whose knowledge is centered, whose is missing, whose body is assumed, and who has access to participate.
- Uses science and technology for agency, action, and repair, not only for classroom performance.
...
My commitment for this course is to treat technology as a design material, not a default solution. I want to document what students are able to notice, build, explain, question, and revise when the learning environment gives them real agency, access, bodymind safety, and multiple ways to show rigorous thinking.
