# Planet Protectors Camp Unit Plan Draft
...
Source links: [Module 1 source map](../../../../docs/source-map.md#module-1-local-sources), [course scope](../../../../docs/course-scope.md), [archived public DOCX export](../../../../public-submissions/archive/2026-07-18-pre-consolidation/planet-protectors-camp-unit-plan-draft.docx)
...
### Day 1 - Notice and Question: Where Does Plastic Show Up?

**Student-friendly target:** I can notice plastic pollution patterns, ask investigable questions, and explain why the issue matters to people and places.

**Opening community move:** Students choose a "place I care about" card or sketch: park, street, school, home, river, playground, bus stop, store, garden, or imagined future place.
...
**Student-friendly target:** I can collect and organize evidence about plastic pollution while using technology carefully and respectfully.

**Activities:**

1. Review investigation norms: safety, consent for photos, no student faces in evidence photos, no touching unknown or unsafe items.
2. Evidence stations:
   - Sort station: classify sample clean plastics by type/use/source.
...
**Student-friendly target:** I can use evidence to design a message that teaches others about plastic pollution and community care.

**Activities:**

1. Revisit evidence wall: Students identify one pattern, one surprise, and one question.
2. Mini-lesson on audience: families, younger kids, teachers, neighbors, city leaders, camp community.
3. Create showcase products:
   - poster
   - mini data story
   - map with captions
...
**Student-friendly target:** I can explain my group's evidence, name a technology affordance/limit, and suggest one action people can take.

**Activities:**

1. Final preparation: choose lead explainers and support roles.
2. Showcase walk: groups present their evidence and community message.
3. Reflection circle:
...
- clean plastic sample items or printed/plastic-free image cards
- gloves or safety tools if handling any collected materials
- chart paper, sticky notes, markers
- tablets/phones/cameras if available
- optional magnifier or low-cost microscope attachment
- shared spreadsheet or paper data table
...
- Do not touch sharp, dirty, chemical, medical, or unknown waste.
- Use clean samples or observation-only evidence when safety is uncertain.
...
After each day, the facilitation team should record:

1. What students were most curious about.
2. Where participation was strong or uneven.
...
OpenAI Codex (GPT-5) was used on July 1, 2026 to synthesize course requirements, connect the plan to JuST/PICRAT/Puzzle Plan goals, and draft this initial unit plan. Final group decisions, daily revisions, and submitted plans should reflect the actual team, teacher, and youth feedback.
