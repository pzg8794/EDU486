...
| 8 | July 15 team-meeting commitments | Piter's opening moment, revised human-body phenomenon, gapless explanation, four checklist connections, and inclusive advocacy choices are prepared for team review | [Editable team document](https://docs.google.com/document/d/1QsQegxXvaDkFnD_BhWYT9qtfez46bugYwCFkmSHN_OA/edit) / [commitment pack](july15-meeting-commitment-pack.md) / [evidence-to-agency visual](../../public-artifacts/invisible-invaders-evidence-to-agency-map.png) |
...
Use the [completed Invisible Invaders explanation](invisible-invaders-gapless-explanation.md), [activity plan](invisible-invaders-activities.md), [plastic-carbon-temperature extension](invisible-invaders-plastic-carbon-temperature-model.md), and [media guide](invisible-invaders-media-guide.md) for the three official shared-document tabs. The earlier [three-team options](gapless-explanation-options.md) remain as planning history.
