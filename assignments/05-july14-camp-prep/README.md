...
| 7 | Curriculum exploration and camp-week design | Complete source audit, Puzzle Plan adaptation, Monday-Friday arc, camp tools, visual, and folder index; Piter + Aastha still need to confirm the research question and shared preparation roles | [Task 7 plan](task7-curriculum-adaptation-and-week-plan.md) / [camp tools](task7-camp-tools.md) / [visual](../../public-artifacts/task7-curriculum-to-camp-map.png) / [folder index](invisible-invaders-camp-folder-index.md) / [curriculum map](camp-curriculum-resource-map.md) |

## Team Gapless Explanation

I am working with Aastha as the **Invisible Invaders**. Our camp investigates why microplastics can appear in outdoor parking-lot samples and indoor classroom samples even when they are invisible to unaided eyes. Neurodivergence, chronic illness, disability, language, culture, and multiple identities shape how we make the investigation safe, understandable, rigorous, and open to different forms of participation.
...
Use the [completed Invisible Invaders explanation](invisible-invaders-gapless-explanation.md), [activity plan](invisible-invaders-activities.md), and [media guide](invisible-invaders-media-guide.md) for the three official shared-document tabs. The earlier [three-team options](gapless-explanation-options.md) remain as planning history.
