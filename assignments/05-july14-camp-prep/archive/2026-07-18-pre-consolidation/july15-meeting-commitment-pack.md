# Invisible Invaders: July 15 Meeting Commitment Pack
...
| My commitment | Completed here | Team decision still needed |
| --- | --- | --- |
...
## 2. Revised Phenomenon And Driving Question
...
### Evidence boundary displayed beside the question

> **Detected does not mean proven harmful.** The FDA reports that microplastics have been found in human samples, but major questions about health effects and measurement remain. Our campers can investigate sources, pathways, evidence, systems, and possible prevention without being told that a particular disease has been proven. [FDA: evidence and remaining uncertainty](https://www.fda.gov/food/environmental-contaminants-food/microplastics-and-nanoplastics-foods)

## 3. Recommended Opening Moment

### The Evidence Pathway Mystery: 40-45 Minutes

This keeps the mystery structure from the team's **Friday - Anchoring Phenomenon Routine**, but it does not stage litter, identify untested particles as plastic, use fear about bodies, or require anyone to touch an unknown sample.
...
#### Step 1 - Notice without a forced performance: 6 minutes

Each camper chooses an evidence card or object they are willing to examine. They can write, draw, point, dictate, speak, or quietly place a **notice** and a **question** beside it. We do not hide the purpose from students or tell them a sample is confirmed plastic when it is not.

#### Step 2 - Reveal the research evidence and its limit: 7 minutes

Place the blood and lung evidence cards on the human silhouette. Say: **"These studies detected plastic particles in some human samples. They do not tell us that every person has the same exposure, where each particle came from, or what health effect it caused."** Campers mark what the evidence supports, what it does not support, and what they now wonder.
...
Sort questions under five image-and-text headings: **sources, becoming small, movement, living bodies, systems and action**. Keep camper wording visible. Questions about health are recorded honestly and marked for trusted-source research rather than answered through speculation.

#### Step 5 - End with agency, not fear: 7-10 minutes

Show the five advocacy pathways without asking campers to choose yet. Ask: **"Which part of this system would you want the power to investigate or change, and what evidence would you need?"** Campers place a removable marker or private response; they may change it as the week develops.

### Other Feasible Moments
...
These are the four course ideas selected in the team document after the meeting. Each one is translated into a causal idea campers can actually place on their model.
...
After every activity, campers answer five short prompts:

1. **What did we do or examine?**
2. **What did we observe?**
3. **Why might it have happened?**
4. **Which checklist idea does this evidence support, complicate, or leave unanswered?**
5. **What do we add, change, question, or remove from our model?**

## 5. Revised Gapless Explanation
...
People and other organisms may encounter small particles through air, food, water, and contact with environments and materials. Researchers have chemically identified plastic particles in some human blood and lung-tissue samples, which supports the claim that particles can reach internal human samples. Those detections do not reveal one universal route and do not, by themselves, prove a particular health effect. [Blood study](https://pubmed.ncbi.nlm.nih.gov/35367073/), [lung study](https://pubmed.ncbi.nlm.nih.gov/35364151/), and [WHO evidence review](https://www.who.int/publications/i/item/9789240054608)
...
> Plastic in everyday products can become smaller through friction and weathering without disappearing. Because Earth systems are connected, particles can move through air, water, soil, buildings, infrastructure, food webs, and human activity before settling or being encountered by living organisms. Researchers have detected plastic particles in some human samples, but detection does not prove a particular health effect or identify one universal source. Product design, purchasing, transportation, stormwater, buildings, waste systems, monitoring, and policy can all change parts of the pathway, so campers need evidence and several possible routes for action.

## 6. Inclusive Advocacy Choice Studio

Campers do not receive a predetermined solution. We teach how to match **evidence -> system point -> decision-maker -> request -> justice check**, then let youth choose or create the direction.
...
- Does our evidence support the request?
- Who has the authority and resources to act?
- Who benefits, who bears exposure or cleanup labor, and whose knowledge counts?
- Would the proposal create cost, time, health, language, mobility, or sensory barriers for people with fewer choices?
- Does the action preserve more than one way to participate and communicate?
- Are we promising more than the science can establish?

### Bioplastics caution

Learning about new materials is appropriate; presenting **biodegradable** as an automatic solution is not. NOAA explains that many bio-based, biodegradable, or compostable plastics require industrial conditions and may persist in soil or marine environments. Campers can evaluate a material claim by asking **where, under what conditions, how quickly, into what products, and who controls the disposal system?** [NOAA: biodegradable-plastic evidence limit](https://marinedebris.noaa.gov/what-marine-debris/plastic#biodegradable)

## 7. Access Is Part Of The Lesson Mechanism

- **Body-topic choice:** Preview the human-sample evidence and provide an equivalent environment-only route for campers who do not want to engage with body imagery.
- **Observation choice:** Printed image, sealed object, shared camera, magnified still, or partner description.
- **Modeling choice:** Movable cards, drawing, writing, speech, audio, digital diagram, home language, or co-authored model.
- **Energy and movement choice:** Mobile investigator, seated mapper, evidence checker, timekeeper, question organizer, or quiet researcher.
- **Communication choice:** Live speech, partner-supported explanation, annotated image, writing, audio, video, art, or private contribution to a shared product.
- **Regulation:** Visible agenda, one instruction at a time, processing time, predictable transitions, sensory break, and no forced touching, tasting, smelling, or public disclosure.

Every route still asks campers to build a causal pathway, use evidence, identify uncertainty, revise a model, and justify an action.

## 8. Team Review Queue

### Prepared by Piter for review

- [x] Revised phenomenon and driving question
- [x] Four feasible opening moments
- [x] Detailed recommended opening experience
- [x] Four selected checklist ideas connected to lesson evidence
- [x] Revised gapless explanation
...
- [ ] What question do we want April to answer before we finalize the plan?

## 9. Evidence From Our Meeting
...
- **00:54:13-00:54:56:** I agreed to brainstorm feasible moments and prepare a less busy template for us to review and clean up together.

The automatic transcript remains a protected local source because speaker labels and wording are not fully verified and the conversation includes informal team discussion.

## AI Use Disclosure

I used OpenAI Codex on July 16, 2026 under my supervision and guidance to organize the commitments I made during our July 15 meeting, connect them to our course documents and transcripts, validate scientific claims with direct sources, and make the planning packet more accessible and inclusive. I, Piter Garcia, provided the team context, priorities, inclusion requirements, questions, and decisions that shaped this work. I reviewed and remain responsible for the final science, language, representation of Aastha's contributions, and what we use or submit.
