...
```mermaid
flowchart LR
    A["Fossil raw materials"] --> B["Plastic production"]
    B --> C["Transport and product use"]
    C --> D["Waste, recycling, or burning"]
    A --> E["Greenhouse-gas emissions"]
    B --> E
    C --> E
    D --> E
    E --> F["More outgoing infrared energy is absorbed and re-emitted"]
    F --> G["Earth's surface and lower atmosphere warm"]
    C --> H["Wear and shedding"]
