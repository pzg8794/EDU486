...
- Session 1 (June 29): youth STEM community story completed.
- Session 2 (July 2): PICRAT reading and video, classroom design, Ambitious Science Teaching excerpt, and Science in Action video completed.
...
- *What Equity Means to Me* zine: paper copy is not available in the local course folder or connected Drive.
- Rios, *You Have to Be Willing to Look Deeply*: the assigned chapter was not found in the local course folder or connected Drive.

The live table labels these rows as pending instead of substituting generic summaries or unverified quotations.

## Maintenance Rule

Update the table after each completed class session. Each reading row should contain a concise main point, evidence or findings, a verified short quotation with a page or timestamp when available, and a personalized question connected to EQUITAS Access-to-Agency STEM.
