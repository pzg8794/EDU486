...
- [2026 Syllabus EDU 486 Google Doc](https://docs.google.com/document/d/1FQ1gwTCD7cqL5Hj5xVIAI4p4WFQ8AXLuqOGCuwKwVFk/edit)
- protected Blackboard announcement, "Getting ready for class on Tuesday - Welcome"
- protected Module 1 Blackboard/course readings
...
- course focus on justice-oriented, culturally sustaining, place-based technology integration in STEM
- modules: Getting Grounded, Planning, Camping, Reflecting
- required on-site participation at Freedom School / Planet Protectors Camp
- major assignments:
  - Visualizing our Grounding Frameworks, Part 1 and Part 2
...
- repository correction: EDU486 work must be framed through [EQUITAS Access-to-Agency STEM](access-to-agency-course-theme.md), not generic technology integration alone

## Announcement Requirements Extracted

From the protected Blackboard announcement, "Getting ready for class on Tuesday - Welcome":
...
- Kimmons, Graham, and West, PICRAT reading, pp. 184-195: protected course PDF
- [PICRAT video by Royce Kimmons](https://www.youtube.com/watch?v=bfvuG620Bto), with protected local notes/transcript
- [Colbert, classroom design and behavior](https://www.communityplaythings.com/resources/articles/classroom-design-and-how-it-influences-behavior), with protected local course copy
- Windschitl, Thompson, and Braaten, Ambitious Science Teaching excerpt: protected course PDF
- [Science in Action video, California Academy of Sciences](https://www.youtube.com/watch?v=Jj9iNphbY88), with protected local notes/transcript
- "What Equity Means to Me" zine, paper copy distributed in class; no local digital file found in the course folder
- Ravel and Sneider practical research PDF: protected course PDF

For July 7:

- Avery, rural science education and local knowledge: protected course PDF
- [Seiki, Dominguez, and Asato, border crossing between home and school](https://files.eric.ed.gov/fulltext/EJ1304646.pdf), with protected local course copies
- Yosso, community cultural wealth: protected course PDF
- [REL culturally sustaining pedagogy resource](https://ies.ed.gov/ncee/rel/regions/pacific/pdf/REL_CulturallySustainingPedagogy_508.pdf), with protected local course copy

For July 9/10:

- AI-assisted technology evolution mini-presentation directions: protected course PDF
- Module 1 session checklist: protected course PDF
...
- completed Module 1 reflection and selected journals in Piter's private DataScience/Drive journal corpus, used only as voice, lived-experience, and content-organization references and not copied into the public repository
- [current Invisible Invaders Camp Operations Guide](../assignments/03-camp-unit-plan/invisible-invaders-camp-operations-guide.md)
...
The guide reconciled the session's agreed team identity, anchor, instructional question, Field Friday sand work, then-current four-jar idea, neighborhood map, scientist circles, daily model revision, justice/power analysis, advocacy art, research evidence, access routes, and materials. The current SASSY table preserves the team's activity rows from the July 16 photograph, removes the instructor's sample Charlotte Beach storyline, attaches every connecting question directly to a Gotta-Have checklist item, and completes the team's blank future-modeling row with a Thursday two-branch synthesis and a brief Friday evidence check. The July 23 Friday source packet later replaced the four-jar implementation with the two-reference-plus-mystery case documented below. The first-day/advocacy-day checklist placement follows the later recorded team decision to reverse the earlier labels visible in the photograph. Other-team boards remain reference-only evidence for shared-resource coordination.
...
The July 21 record established the 40-minute Friday team session with a 12-minute backup, short demonstrations, proactive check-ins, optional public sharing, movement and low-energy routes, friendly scientific missions, and meaningful early-finisher extensions. Its four-model/three-sample kit is planning history: the July 23 Friday source packet below supersedes that equipment configuration while preserving the timing and access commitments. The live sheet records trays and three scoops as USD 0 LeChase reservations; the current six-sample plan requires confirmation of three additional clean scoops. The connected purchase value remains USD 86.79 before tax.
...
## July 23 Field Friday Source-Packet Reconciliation

- [Newer seven-tab Friday source packet](https://docs.google.com/document/d/1vpMdBbTJAJRYH0OOQwd1GC8pjrRMzCu8UoeZ5RVQI80/edit)
- [Updated seven-tab Friday Anchoring Phenomenon Routine](https://docs.google.com/document/d/16iqraS0TefwyGQdTOlp2s-sQnIWB6DgCOptWtB8vWJ0/edit)
- [Reconciled current Camp Operations Guide](https://docs.google.com/document/d/1LueJ9NX6MP257ywABKTDu-vVWVYzTwRnNDK8fgJx4e0/edit)
- [Editable eight-slide Field Friday Visual Guide](https://docs.google.com/presentation/d/1aEEMEWiIwTtmNnP2zNhW21cBl0Aow-OQW-kSC7mMfrk/edit)
- [Repository facilitator guide](../assignments/03-camp-unit-plan/friday-anchoring-phenomenon-routine.md)
- [Portable visual-guide PPTX](../public-submissions/invisible-invaders-field-friday-visual-guide.pptx)
- [Portable visual-guide PDF](../public-submissions/invisible-invaders-field-friday-visual-guide.pdf)
